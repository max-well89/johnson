    ...
    public function init()
    {
        ...
        $this->dbHelper->addQuery($this->getAction() . '/insert_data', '
                ...
                values (
                    ...
                    (select name_ru from v_sku_status where id_status = (select id_status from t_sku where id_sku = :id_sku limit 1) limit 1), 
                    :id_pharmacy::bigint, 
        ...
        $this->dbHelper->addQuery($this->getAction() . '/update_data', '
                ...
                set
                    ...
                    sku_status_name = (select name_ru from v_sku_status where id_status = (select id_status from t_sku where id_sku = :id_sku limit 1) limit 1),
