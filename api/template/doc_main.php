...
<p>Взаимодействие с модулем хранения данных участников акции осуществляется посредством отправки HTTPS POST-запросов к
    интерфейсу взаимодействия <?php echo $this->context->getApiUrl(); ?>, содержащих в теле POST-запроса JSON-документ
    вида:</p>
...
<table class="table table-condensed">
    ...
    <tr>
        <td>1</td>
        <td>Некорректный формат JSON</td>
    </tr>
    <tr>
        <td>2</td>
        <td>Некорректная операция</td>
    </tr>
    <tr>
        <td>3</td>
