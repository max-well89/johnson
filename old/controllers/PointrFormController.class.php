...
class PointFormController extends AbstractFormController{
    /** @var int ID объекта */
    private $id_object = 0;
    ...
    protected function processGetForm() {
        //вяжем данные
        $form = new PointForm($this->context, array('id' => $this->formId));
        $form->bind($this->object);

        $formTitle = "Торговая точка";
    ...
    protected function processSaveForm() {
        ...
        $form = new DealerForm($this->context, array('id' => $this->formId));
          ...
          --              longitude = :longitude,
            --            id_parking_tariff = :id_parking_tariff,
              --          id_status = :id_status  
                ...
                $this->id_object = $values["id_point"];
                //}
                //else {
