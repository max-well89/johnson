...
class FeedbackFilterForm extends nomvcAbstractFilterForm{
    public function init() {
        parent::init();

//        Период
        $this->addWidget(new nomvcInputDatePeriodPickerWidget("Дата сообщения", "dt"));
        $this->addValidator("dt", new nomvcDatePeriodValidator());

//        $this->addWidget(new nomvcInputTextWidget('Название', 'name'));
//        $this->addValidator('name', new nomvcStringValidator(array('required' => false,'min' => 2, 'max' => 100)));
...
//        $this->addWidget(new nomvcButtonWidget('Добавить дилера', 'create', array(
//            'type' => 'button',
//            'icon' => 'file'
//        ), array(
//            'onclick' => "return TableFormActions.getForm('dealer');",
