...
class DealerFormController extends AbstractFormController{
    /** @var int ID объекта */
    private $id_object = 0;
            ...
            ---            :longitude,
               --         :id_parking_tariff,
                 --       :id_status
					...
					returning id_dealer into :id_object");
          ...
          --              longitude = :longitude,
            --            id_parking_tariff = :id_parking_tariff,
              --          id_status = :id_status  
                ...
                $this->id_object = $values["id_dealer"];
                //}
                //else {
