...
class RestaurantFormController extends AbstractFormController{
    /** @var int ID объекта */
    private $id_object = 0;
    ...
    protected function processGetForm() {
        //вяжем данные
        $form = new RestaurantForm($this->context, array('id' => $this->formId));
