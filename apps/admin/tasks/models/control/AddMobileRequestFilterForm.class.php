...
class AddMobileRequestFilterForm extends nomvcAbstractFilterForm{
    public function init() {
        ...
        $this->addWidget(new nomvcInputTextWidget('ID запроса', 'id_mobile_point'));
        $this->addValidator('id_mobile_point', new nomvcIntegerValidator(array('required' => false)));
        ...
        $this->addWidget(new nomvcSelectFromMultipleDbWidget('Тип запроса', 'id_mobile_purpose', array(
            'helper' => $this->context->getDbHelper(),
            'table' => 'T_MOBILE_PURPOSE',
            'order' => 'name',
            'required' => false,
            'multiple' => true
        ), array()));
        $this->addValidator('id_mobile_purpose', new nomvcValueInDbMultipleValidator(array(
            'required' => false,
            "helper" => $this->context->getDbHelper(),
            "table" => "T_MOBILE_PURPOSE",
            "key" => "id_mobile_purpose"
        )));
