...
abstract class nomvcAbstractTable
{
    ...
    public function stringFormatter($column, $row)
    {
        return $row->get($column);
    }

    public function integerFormatter($column, $row)
    {
        return $row->get($column);
    }
    ...
    public function emailFormatter($column, $row)
    {
        return $row->get($column);
    }
    ...
    protected function removeColumn($key)
    {
