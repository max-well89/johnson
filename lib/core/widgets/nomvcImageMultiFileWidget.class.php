...
EOF
    ...
    public function renderOneImage($photo)
    {
        ...
        $checked_is_logo = "";
        //лого
        if ($this->getOption("show-logo")) {
            $logo_visible = "";
        } else {
            $logo_visible = 'style="display: none;"';
        }
        //заставка
        if ($this->getOption("show-splash")) {
            $splash_visible = "";
        } else {
            $splash_visible = 'style="display: none;"';
        }
        ...
        if (!empty($photo)) {
            ...
            if (array_key_exists("is_logo", $photo)) {
                if ($photo["is_logo"] == 1) $checked_is_logo = "checked";
            }
